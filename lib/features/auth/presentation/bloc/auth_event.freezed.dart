...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _CheckStatus value)?  checkStatus,TResult Function( _Login value)?  login,TResult Function( _Register value)?  register,TResult Function( _Logout value)?  logout,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CheckStatus() when checkStatus != null:
return checkStatus(_that);case _Login() when login != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _CheckStatus value)  checkStatus,required TResult Function( _Login value)  login,required TResult Function( _Register value)  register,required TResult Function( _Logout value)  logout,}){
final _that = this;
switch (_that) {
case _CheckStatus():
return checkStatus(_that);case _Login():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _CheckStatus value)?  checkStatus,TResult? Function( _Login value)?  login,TResult? Function( _Register value)?  register,TResult? Function( _Logout value)?  logout,}){
final _that = this;
switch (_that) {
case _CheckStatus() when checkStatus != null:
return checkStatus(_that);case _Login() when login != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  checkStatus,TResult Function( String email,  String password)?  login,TResult Function( String email,  String password)?  register,TResult Function()?  logout,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CheckStatus() when checkStatus != null:
return checkStatus();case _Login() when login != null:
return login(_that.email,_that.password);case _Register() when register != null:
return register(_that.email,_that.password);case _Logout() when logout != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  checkStatus,required TResult Function( String email,  String password)  login,required TResult Function( String email,  String password)  register,required TResult Function()  logout,}) {final _that = this;
switch (_that) {
case _CheckStatus():
return checkStatus();case _Login():
return login(_that.email,_that.password);case _Register():
return register(_that.email,_that.password);case _Logout():
return logout();case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  checkStatus,TResult? Function( String email,  String password)?  login,TResult? Function( String email,  String password)?  register,TResult? Function()?  logout,}) {final _that = this;
switch (_that) {
case _CheckStatus() when checkStatus != null:
return checkStatus();case _Login() when login != null:
return login(_that.email,_that.password);case _Register() when register != null:
