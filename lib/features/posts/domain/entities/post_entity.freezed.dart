...
@override
String toString() {
  return 'PostEntity(id: $id, title: $title, description: $description, createdAt: $createdAt, userId: $userId)';
}
...
class _PostEntity implements PostEntity {
  const _PostEntity({required this.id, required this.title, required this.description, required this.createdAt, required this.userId});
